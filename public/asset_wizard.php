...
if($_SERVER['REQUEST_METHOD']==='POST'){
 ...
 if($step!=='review'&&$action==='next'){
  ...
  foreach($records as $idx=>$record){
   if(isset($_POST['remove'][$idx]) && (string)$_POST['remove'][$idx]==='1') continue;
