...
## شبکه و چاپگر در نسخه 0.1.0.8
مقادیر شبکه به آرایه‌های ساختاریافته تبدیل می‌شوند و آدرس‌ها/آداپتورهای پیش‌فرض یا مجازی ویندوز مانند Loopback، APIPA و آداپتورهای مجازی شناخته‌شده حذف می‌شوند. داده‌های چاپگر از PrinterDetails، PrinterNames، PrinterPorts و PrinterDrivers تجمیع و نرمال می‌شوند.
